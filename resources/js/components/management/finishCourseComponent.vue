...
<template>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h1 class="text-center" v-if="this.finish_course">Proceso de calificación de la actividad de formación</h1>
        <h1 class="text-center" v-if="!this.finish_course">Actividad de formación Calificada</h1>
        <hr>
      </div>
      <div class="col-3">
      ...
      <div class="col-9">
        ...
        <div class="row">
          ...
          <div class="col-4">
            <p><strong>Lugar: </strong>{{curso1.place}}</p>
    ...
    <div class="row" v-if="students1.length > 0 && students2 == ''">
      <div class="col-12">
        <hr>
            ...
            <tbody>
              <tr v-for="student in students1">
                ...
                <td>
                  ...
                  <input type="checkbox" checked data-toggle="toggle" data-width="150" data-size="sm" data-onstyle="success" data-offstyle="warning" data-on="Aprobado" checked data-off="No Aprobado">
                </button>
               </td>
              </tr>
            </tbody>
    ...
    <div class="row" v-if="!this.finish_course && this.students2.length > 0">
      <div class="col-12">
        <hr>
    ...
    <div class="row">
      <div class="col-12 d-flex justify-content-center">
        <button class="btn btn-secondary btn-lg" type="button" name="button" v-on:click="finishCourse()" v-if="this.finish_course">Terminar</button>
        <a href="/myEventsAliado"><button class="btn btn-secondary btn-lg" type="button" name="button" v-if="!this.finish_course">Ir a mis actividades de formación</button></a>
      </div>
